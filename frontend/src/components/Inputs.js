...
import { daoDealClientAddress, governorContractAddress } from "../helpers";
const CID = require("cids");

// Replace this address with the address of own instance of the deal client contract
// const governorContractAddress = "0x2B198Ce3796FAdf240484ff37aCf9E674815768C";
// const daoDealClientAddress = "0x2122f03686Bb541F6a921a1EF839a8A4930f5833";
// 0x99674D1336F6ac4aA9f9B6eadd1FE24dEEda2e4d
let governor;
let cid;
let client;
...
function Inputs() {
  ...
  // useEffect(() => {
  //   async function getPrp() {
  //     try {
  //       const { ethereum } = window;

  //       if (ethereum) {
  //         const provider = new ethers.BrowserProvider(ethereum);
  //         const signer = provider.getSigner().then((data) => data);
  ...
  //         const encodedFunctionCall = client.interface.encodeFunctionData(
  //           "getAllDealProposals"
  //         );
  //         // const proposals = await client.getAllDealProposals();
  //         // const receipt = await proposals.wait();
